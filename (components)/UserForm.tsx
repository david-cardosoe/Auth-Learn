    ...
    return (
        <>
            <form onSubmit={handleSubmit} method="post" className="flex flex-col gap-3 w-1/2">
                ...
                required={true} value={formData.name} className="m-2 bg-slate-400 rounded" />

                <label>Email</label>
                <input id="email" name="email" onChange={handleChange} type="text"
                required={true} value={formData.email} className="m-2 bg-slate-400 rounded" />

                <label>Password</label>
                <input id="password" name="password" onChange={handleChange} type="password"
                required={true} value={formData.password} className="m-2 bg-slate-400 rounded" />
